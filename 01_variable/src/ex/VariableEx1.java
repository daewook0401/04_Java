...
public class VariableEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * long	 (8byte) 
		 * -> 숫자 뒤에 L 또는 l을 붙힘 (L, l의 long의 리터럴)
		 * 
		 * - 실수형
		 * float  (4byte)
		 * -> 숫자 뒤에 F 또는 f를 붙임
		...
		// 변수 선언
		int num1; 
		// 메모리에 int형 정수를 저장할 공간 4byte 할당하고 
		...
		int intNum1 = 2147483647; // int형 최대값
		...
		// 2147483648L 또는 2147483648l 표기 == long으로 인식된
		long longNum1 = 2147483648L; // long형 리터럴
		
		// 자릿수 구분을 위해 _ 사용 가능 -> 연산지 불한한지 확인
	    ...
	    char ch3 = '1';	//
		char ch4 = ' '; // 공백도 문자로 인식
		char ch5 = '↓'; // 특수문자도 문자로 인식
		char ch6 = '金'; // 한자도 문자로 인식
