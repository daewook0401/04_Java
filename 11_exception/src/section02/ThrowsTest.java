...
public class ThrowsTest {
	...
	/* Unchedcked Exception
	 * - 예외 발생 여부를 확인하지 않아도 되는 예외
	 *  == 예외 처리 구문(try-catch, throws)을
	 *  	 안써도 되는 예외
	 * 
	 * -RuntimeException의 자식 예외들이 이에 속합
	 * 
	 * Checked Exception:
	 * - 예외 발생 여부를 꼭 확인해야되는 예외
	 *  == 예외 처리 구문(try-catch, throws을
	 *  	 무조건 작성해야되는 예외
	 *  
